...
def dashboard():
    ...
    return render_template_string(TEMPLATE, servers=SERVERS, registrations=registrations, base_url=BASE_URL, script_dir=script_dir)
    ...
    {% for id, server in servers.items() %}
        <div class="card">
            ...
            <div class="dcr-payload">
                <div class="dcr-label">DCR Request Payload (both agents send this):</div>
